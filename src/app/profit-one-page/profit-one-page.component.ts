...
export class ProfitOnePageComponent implements OnInit {
  profits: any = [
    ...
    },
    {
      ...
      title: "Чисто и уютно",
      text: "Красивейшая студия в самом центре города. В работе мы используем только одноразовые полотенца и дезинфицируем инструменты после каждого клиента."
    },
    {
      img: "assets/imgs/profit-one-page/9.png",
      title: "Выгляди<br>неотразимо",
      text: "С помощью наращивания волос вы будете шикарно выглядеть и сможете отрастить свои волосы. Так же наращивание внесет разнообразие в Вашу личную жизнь, поможет выделиться и произвести впечатление на окружающих, и своего мужчину."
    },
    {
      img: "assets/imgs/profit-one-page/10.png",
      title: "Гарантия на волосы<br>и работу",
      text: "Мы профессионалы, поэтому даем гарантию на свою работу и волосы - 3 года!"
    }
  ];
